...
async function handler(req,res){
  ...
  const cacheKey=`v176-3h-oddsapiio-footballdata|${date}|${requestedCodes?.join(',')||'ALL'}|${timeWindow}|${market}`;
