AI DEL PALLONE – V161 ESPN FIX

OBIETTIVO
La V159 poteva trovare le partite ma scartarle prima dell'analisi per problemi di matching Betfair,
catalogo incompleto e una catena di provider troppo lunga. V161 corregge il percorso a due fonti.

ARCHITETTURA
1. ESPN – calendario, stato, classifica e ultime 3 partite.
   - Nessuna API key.
   - Il formato scoreboard a intervallo YYYYMMDD-YYYYMMDD è stato ritirato da ESPN. V161 usa una chiamata per la giornata richiesta e una per il mese corrente (limit=1000), poi filtra localmente gli ultimi 28 giorni.
